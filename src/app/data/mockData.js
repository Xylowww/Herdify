...
const mockListings = [
  {
    id: "l1",
    title: "Healthy Native Cattle - Batangas Bulls",
    type: "Cattle",
    breed: "Batangas Native",
    age: "2-3 years",
    weight: "300-350 kg each",
    price: 45e3,
    head: 5,
  ...
  {
    id: "l2",
    title: "Anglo-Nubian Dairy Goats",
    type: "Goat",
    breed: "Anglo-Nubian",
    age: "1-2 years",
    weight: "40-55 kg",
  ...
  {
    id: "l3",
    title: "Free-Range Native Chickens",
    type: "Chicken",
  ...
  {
    id: "l4",
    title: "Carabao - Strong Work Animals",
    type: "Carabao",
  ...
  {
    id: "l5",
    title: "Landrace Piglets for Fattening",
    type: "Pig",
    breed: "Landrace",
    age: "2-3 months",
    weight: "15-20 kg",
  ...
  {
    id: "l7",
    title: "Boer Goats - Premium Meat Breed",
    type: "Goat",
    breed: "Boer",
    age: "8-12 months",
    weight: "30-40 kg",
...
const mockConversations = [
  {
    id: "c1",
    listingId: "l1",
    listingTitle: "Healthy Native Cattle - Batangas Bulls",
  ...
  },
  {
    id: "c2",
    listingId: "l2",
    listingTitle: "Anglo-Nubian Dairy Goats",
  ...
  },
  {
    id: "c3",
    listingId: "l5",
    listingTitle: "Landrace Piglets for Fattening",
...
const mockTransactions = [
  { id: "t1", listingId: "l6", listingTitle: "Brahman Cross Heifers", listingType: "Cattle", buyerId: "u1", buyerName: "Juan Dela Cruz", sellerId: "u6", sellerName: "Carlo Gutierrez", amount: 152e3, head: 4, status: "Completed", date: "2024-11-19", location: "Batangas City, Batangas" },
  { id: "t2", listingId: "l2", listingTitle: "Anglo-Nubian Dairy Goats", listingType: "Goat", buyerId: "u5", buyerName: "Rosa Mendoza", sellerId: "u2", sellerName: "Maria Santos", amount: 36e3, head: 3, status: "Completed", date: "2024-11-10", location: "Lipa City, Batangas" },
  { id: "t3", listingId: "l1", listingTitle: "Healthy Native Cattle - Batangas Bulls", listingType: "Cattle", buyerId: "u1", buyerName: "Juan Dela Cruz", sellerId: "u2", sellerName: "Maria Santos", amount: 21e4, head: 5, status: "Pending", date: "2024-11-22", location: "Batangas City, Batangas" },
  ...
  { id: "t5", listingId: "l5", listingTitle: "Landrace Piglets for Fattening", listingType: "Pig", buyerId: "u1", buyerName: "Juan Dela Cruz", sellerId: "u4", sellerName: "Pedro Ramos", amount: 27e3, head: 6, status: "Cancelled", date: "2024-11-05", location: "Tanauan, Batangas" }
];
const mockReports = [
...
const LIVESTOCK_TYPES = ["Cattle", "Goat", "Sheep", "Pig", "Chicken", "Carabao", "Other"];
const STATUS_COLORS = {
