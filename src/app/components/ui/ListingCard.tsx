...
export function ListingCard({ listing, compact = false }: ListingCardProps) {
  ...
  return (
    <div className="card-modern group cursor-pointer h-full flex flex-col overflow-hidden">
      <Link to={`/listings/${listing.id}`} className="block flex-1 flex flex-col">
        ...
        <div className="p-4 flex-1 flex flex-col bg-gradient-to-b from-white to-[#FAFAF8]">
          ...
          {!compact && (
            <div className="flex items-center justify-between pt-3 border-t border-[#F0EDE8]/80 mt-auto">
