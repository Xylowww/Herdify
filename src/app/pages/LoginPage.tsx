...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    // Demo: check if email matches a demo account
    ...
    <div className="min-h-screen bg-[#F6F4EE] flex" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
        ...
        <div className="relative z-10 flex flex-col justify-between p-10 text-white">
          ...
          <div>
            ...
            <div className="space-y-3">
              {['Secured with hashed passwords and 2FA', 'Location privacy built-in by default', 'Role-based access for buyers, sellers, admins'].map((t) => (
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          {/* Rate limit warning */}
          {loginAttempts >= 3 && (
            <div className="flex items-start gap-2.5 p-3.5 rounded-xl glass border border-amber-200/50 mb-4" style={{ background: 'rgba(251, 191, 36, 0.1)' }}>
