...
import {
  MapPin, Scale, Calendar, Tag, ChevronLeft, MessageSquare,
  ShieldCheck, Eye, Heart, Share2, AlertTriangle, CheckCircle2,
  User, Lock, ChevronRight, ChevronLeft as ChevLeft
} from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 space-y-5">
          ...
          <div className="glass-card rounded-2xl overflow-hidden">
            ...
            {/* Thumbnails */}
            {listing.photos.length > 1 && (
              <div className="flex gap-2 p-3 overflow-x-auto scrollbar-hide bg-gradient-to-b from-white to-[#FAFAF8]">
          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-5">
              {[
                ...
                <div key={spec.label} className="flex items-center gap-3 p-4 glass rounded-xl">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="relative">
                ...
                {listing.sellerVerified && (
                  <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-gradient-to-br from-[#2F6B3F] to-[#3a834d] rounded-full flex items-center justify-center shadow-glow">
              ...
              <div>
                ...
                <div className="flex items-center gap-1 mt-0.5">
                  {listing.sellerVerified ? (
                    <span className="text-xs text-[#2F6B3F] flex items-center gap-1">
                      <CheckCircle2 size={11} />
                      Verified Seller
                    </span>
                  ) : (
                    <span className="text-xs text-[#C68A3A] flex items-center gap-1">
            ...
            {isOwnListing ? (
              ...
              <div className="py-3 glass rounded-xl text-center">
