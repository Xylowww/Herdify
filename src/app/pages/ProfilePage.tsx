...
import {
  User, Lock, MapPin, Bell, Shield, Trash2, Download,
  ToggleLeft, ToggleRight, ShieldCheck, Eye, EyeOff,
  Smartphone, Key, AlertTriangle, CheckCircle2, Camera,
  Monitor, Globe, Clock
} from 'lucide-react';
import { useAppStore } from '../store/useAppStore';
import { toast } from 'sonner';

type Tab = 'profile' | 'privacy' | 'security' | 'notifications' | 'data';
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              {currentUser?.verified && (
                <span className="flex items-center gap-1 text-[10px] px-2 py-0.5 bg-white/20 text-white rounded-full" style={{ fontWeight: 700 }}>
              ...
              <div className="bg-white rounded-2xl border border-[#E2DDD5] p-5">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.label} className="flex items-center justify-between py-2 border-b border-[#F0EDE8] last:border-0">
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl border border-[#E2DDD5] p-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.label} className="flex items-center justify-between p-4 rounded-xl border border-[#E2DDD5] hover:bg-[#FAFAF8] transition-all duration-150">
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="bg-white rounded-2xl border border-[#E2DDD5] p-6">
                <div className="flex items-center justify-between p-4 rounded-xl border border-[#E2DDD5] bg-[#FAFAF8]">
                  ...
                  <Toggle value={twoFA} onChange={(v) => { setTwoFA(v); toast.success(v ? '2FA enabled.' : '2FA disabled.'); }} />
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-[#E2DDD5] p-5 h-fit">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className={`p-3 rounded-xl border ${session.current ? 'border-[#2F6B3F]/20 bg-[#F0F7F2]' : 'border-[#E2DDD5]'}`}>
                    <div className="flex items-start gap-3">
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl border border-[#E2DDD5] p-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={n.label} className="flex items-center justify-between p-4 rounded-xl border border-[#E2DDD5] hover:bg-[#FAFAF8] transition-all duration-150">
                    <div>
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="bg-white rounded-2xl border-2 border-[#D64545]/20 p-6">
                ...
                {!showDeleteConfirm ? (
                  ...
                  <div className="p-4 bg-red-50 rounded-xl border border-[#D64545]/20">
