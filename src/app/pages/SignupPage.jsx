      ...
      <div className="flex-1 flex flex-col bg-white px-8 py-8 lg:px-16 lg:py-10 min-h-screen">
        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-[#6B7280] text-base mb-8">Join the livestock marketplace</p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  className={`w-full px-4 py-3 rounded-lg border ${errors.name ? "border-red-400" : "border-gray-300"} text-sm text-[#1F2937] focus:outline-none focus:ring-2 focus:ring-[#2F6B3F]/20 focus:border-[#2F6B3F] transition-all`}
                />
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 rounded border-gray-300 text-[#2F6B3F] focus:ring-[#2F6B3F]"
                />
                <span className="text-sm text-[#6B7280]">
                  I agree to the <a href="#" className="text-[#2F6B3F] hover:underline">Terms</a> and <a href="#" className="text-[#2F6B3F] hover:underline">Privacy Policy</a>
                </span>
              </label>
        ...
        <p className="text-sm text-[#6B7280]">
          ...
          <Link to="/login" className="text-[#2F6B3F] hover:underline" style={{ fontWeight: 600 }}>
            Sign in
          </Link>
        </p>
      </div>

      {/* Right panel - Green field image with overlay */}
